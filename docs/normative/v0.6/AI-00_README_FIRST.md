...
La validación de forma puede devolver `INVALID_REQUEST` sin abrir la
transacción productiva. Todo request válido relee capacidad tenant-aware antes
del lock/registro idempotente, evidencia de replay u otros recursos persistidos.
